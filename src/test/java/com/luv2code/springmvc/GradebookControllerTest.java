...
public class GradebookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("emailAddress", "chad.darby@cc.com");
    }
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        student.setEmailAddress("chad_darby@cc.com");
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("chad_darby@cc.com");
    ...
    public void getStudentHttpRequest() throws Exception {
        student.setFirstname("Chad");
        student.setLastname("Darby");
        student.setEmailAddress("chad.darby@cc.com");
    ...
    @Test
    public void createAValidGradeForStudentDoesNotExistEmptyResponse() throws Exception {
        this.mockMvc.perform(post("/grades")
                                     .contentType(APPLICATION_JSON_UTF8)
                                     .param("grade", "85.0")
                                     .param("gradeType", "math")
    ...
    @Test
    public void deleteValidGrade() throws Exception {
    ...
    @Test
    public void deleteGradeNotFoundHttpRequest() throws Exception {
